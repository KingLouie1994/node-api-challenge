...
Express is a framework that makes it easier to set up a server in node.js. It can intiate a state in node and it also works as middleware. It also handles routing.

- [x] Describe Middleware?

Middleware are scripts that are inserted into the server flow that can handle authentication and other configurations.

- [x] Describe a Resource?

 A resource is an object type that holds data, relations with other resources, and methods in it.
...
We can partition the application by using server side routing.
